...
data = {
    ...
    "問3": {
        "question": "Aにあてはまる言葉を下記①～③から１つ選び、文章を完成させましょう。食欲は、満腹中枢と摂食中枢でコントロールされており、食べ物が入り消化吸収されると、血液中にブドウ糖が増え、血糖と（　A　）の濃度が上がります。すると満腹中枢が刺激されて「もう満腹」と感じ、摂食中枢の活動が抑制されます。早食いの人はブレーキがかかる前にたくさん食べ、知らぬ間に食べ過ぎて
しまう事になります。",
